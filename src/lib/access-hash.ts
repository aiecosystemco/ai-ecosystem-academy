/** Hashing and codes. Pure JS so campus/admin client bundles never pull node:crypto. */

const PASSWORD_SALT = "aea-academy-v1";
...
export function hashPassword(password: string) {
  return sha256(PASSWORD_SALT + password.trim());
}
